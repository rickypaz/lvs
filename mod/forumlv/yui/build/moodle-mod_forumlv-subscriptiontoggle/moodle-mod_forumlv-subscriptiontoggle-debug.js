YUI.add('moodle-mod_forumlv-subscriptiontoggle', function (Y, NAME) {
 ...
 * @main       moodle-mod_forumlv-subscriptiontoggle
 */

/**
 * @namespace M.mod_forumlv
...
var LOGNAME = 'moodle-mod_forumlv-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    _toggleSubscription: function(e) {
        ...
        Y.io(this.get('uri'), {
            data: {
                ...
                forumlvid: clickedLink.getData('forumlvid'),
    ...
    ATTRS: {
         ...
         * @attribute uri
         * @type String
         * @default M.cfg.wwwroot + '/mod/forumlv/subscribe_ajax.php'
         */
        uri: {
            value: M.cfg.wwwroot + '/mod/forumlv/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.mod_forumlv.subscriptiontoggle');
