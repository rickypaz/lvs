...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a forumlv
  As a teacher
  ...
  Scenario: A forced forumlv does not allow to edit the subscribers
    When I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Forced Forumlv 2 |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
      | Subscription mode | Forced subscription |
      | Visible           | Show |
    And I follow "Forced Forumlv 2"
    And I follow "Show/edit current subscribers"
  ...
  Scenario: A forced and hidden forumlv lists only teachers
    When I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Forced Forumlv 2 |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
  ...
  @javascript
  Scenario: An automatic forumlv lists all subscribers
    When I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Forced Forumlv 1 |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
