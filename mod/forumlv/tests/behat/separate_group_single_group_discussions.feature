...
Feature: Posting to groups in a separate group discussion when restricted to groupings
  In order to post to groups in a forumlv with separate groups and groupings
  As a teacher
  ...
  Background:
    ...
    And I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name  | Multiple groups forumlv             |
      | Forumlv type  | Standard forumlv for general use    |
      | Description | Standard forumlv description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G1                                |
    And I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name  | Single groups forumlv               |
      | Forumlv type  | Standard forumlv for general use    |
      | Description | Standard forumlv description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G2                                |
  ...
  Scenario: Teacher with accessallgroups can post in all groups
    ...
    And I follow "Course 1"
    And I follow "Multiple groups forumlv"
    ...
    And I follow "Course 1"
    And I follow "Single groups forumlv"
