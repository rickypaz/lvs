@mod @mod_forumlv
Feature: The forumlv search allows users to perform advanced searches for forumlv posts
  In order to perform an advanced search for a forumlv post
  As a teacher
  ...
  Background:
    ...
    And I add a new topic to "Announcements" forumlv with:
      | Subject | My subject |
      | Message | My message |
    And I follow "Course 1"
    And I add a new topic to "Announcements" forumlv with:
  ...
  Scenario: Perform an advanced search using any term
    ...
    And I press "Search forumlvs"
    And I should see "Advanced search"
    And I set the field "words" to "subject"
    When I press "Search forumlvs"
