...
Feature: Posting to all groups in a separate group discussion is restricted to users with access to all groups
  In order to post to all groups in a forumlv with separate groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | forumlv      | Standard forumlv name    | Standard forumlv description    | C1     | sepgroups    | 1         |

  Scenario: Teacher with accessallgroups can view all groups
    Given I log in as "teacher1"
    And I follow "Course 1"
    When I follow "Standard forumlv name"
  ...
  Scenario: Students can view all participants discussions in separate groups mode
    Given I log in as "teacher1"
    And I follow "Course 1"
    When I add a new discussion to "Standard forumlv name" forumlv with:
      | Subject | Forumlv post to all participants |
    ...
    And I follow "Course 1"
    And I follow "Standard forumlv name"
    Then I should see "Forumlv post to all participants"
