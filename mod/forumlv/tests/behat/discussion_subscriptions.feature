...
Feature: A user can control their own subscription preferences for a discussion
  ...
  Scenario: An optional forumlv can have discussions subscribed to
    ...
    And I should see "Student One will be notified of new posts in 'Test post subject one' of 'Test forumlv name'"
    ...
    And I should see "Student One will NOT be notified of new posts in 'Test post subject one' of 'Test forumlv name'"
    And I should see "Subscribe to this forumlv"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
    And I click on "You are not subscribed to this discussion. Click to subscribe." "link" in the "Test post subject one" "table_row"
  ...
  Scenario: An automatic subscription forumlv can have discussions unsubscribed from
    Given I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Test forumlv name |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
  ...
  Scenario: A user does not lose their preferences when a forumlv is switch from optional to automatic
    Given I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Test forumlv name |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
    ...
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    When I follow "Unsubscribe from this forumlv"
    Then I should see "Student One will NOT be notified of new posts in 'Test forumlv name'"
    And I should see "Subscribe to this forumlv"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
  ...
  Scenario: An optional forumlv prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Test forumlv name |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
    ...
    And I follow "Test forumlv name"
    And I should see "Subscribe to this forumlv"
    And I reply "Test post subject one" post from "Test forumlv name" forumlv with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
      | Discussion subscription | 1 |
    And I reply "Test post subject two" post from "Test forumlv name" forumlv with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
  ...
  Scenario: An automatic forumlv prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Forumlv" to section "1" and I fill the form with:
      | Forumlv name        | Test forumlv name |
      | Forumlv type        | Standard forumlv for general use |
      | Description       | Test forumlv description |
 ...
 Scenario: A user who is not logged in should not be able to subscribe to a discussion
   ...
   And I add a new discussion to "Test forumlv name" forumlv with:
     ...
     | Message | Test post message one |
   And I log out
   When I follow "Test forumlv name"
   Then "You are not subscribed to this discussion. Click to subscribe." "link" should not exist in the "Test post subject one" "table_row"
   And "You are subscribed to this discussion. Click to unsubscribe." "link" should not exist in the "Test post subject one" "table_row"
   And I follow "Test post subject one"
   And "You are not subscribed to this discussion. Click to subscribe." "link" should not exist
