...
/**
 * The mod_forumlv post updated event.
 *
 * @package    mod_forumlv
...
/**
 * The mod_forumlv post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_forumlv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumlv', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
