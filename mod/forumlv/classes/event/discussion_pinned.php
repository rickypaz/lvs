...
/**
 * The mod_forumlv discussion pinned event.
 *
 * @package    mod_forumlv
...
class discussion_pinned extends \core\event\base {
    ...
    public function get_description() {
        return "The user {$this->userid} has pinned the discussion {$this->objectid} in the forumlv {$this->other['forumlvid']}";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionpinned', 'mod_forumlv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumlv', 'pin discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
