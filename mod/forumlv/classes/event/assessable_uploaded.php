...
/**
 * The mod_forumlv assessable uploaded event.
 *
 * @package    mod_forumlv
...
/**
 * The mod_forumlv assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has posted content in the forumlv post with id '$this->objectid' " .
            "in the discussion '{$this->other['discussionid']}' located in the forumlv with course module id " .
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_forumlv');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/forumlv/discuss.php', array('d' => $this->other['discussionid'], 'parent' => $this->objectid));
    }
