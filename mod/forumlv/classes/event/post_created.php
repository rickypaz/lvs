...
/**
 * The mod_forumlv post created event.
 *
 * @package    mod_forumlv
...
/**
 * The mod_forumlv post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_forumlv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumlv', 'add post', $logurl, $this->other['forumlvid'], $this->contextinstanceid);
    }
