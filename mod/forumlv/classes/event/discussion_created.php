...
/**
 * The mod_forumlv discussion created event.
 *
 * @package    mod_forumlv
...
/**
 * The mod_forumlv discussion created event class.
 *
...
class discussion_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the discussion with id '$this->objectid' in the forumlv " .
    ...
    public static function get_name() {
        return get_string('eventdiscussioncreated', 'mod_forumlv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumlv', 'add discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
