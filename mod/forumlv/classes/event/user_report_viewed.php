...
/**
 * The mod_forumlv user report viewed event.
 *
 * @package    mod_forumlv
...
/**
 * The mod_forumlv user report viewed event class.
 *
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'mod_forumlv');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/mod/forumlv/user.php', array('id' => $this->relateduserid,
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumlv', 'user report', $logurl, $this->relateduserid);
    }
