...
/**
 * The mod_forumlv discussion unpinned event.
 *
 * @package    mod_forumlv
...
class discussion_unpinned extends \core\event\base {
    ...
    public function get_description() {
        return "The user {$this->userid} has unpinned the discussion {$this->objectid} in the forumlv {$this->other['forumlvid']}";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionunpinned', 'mod_forumlv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumlv', 'unpin discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['forumlvid'])) {
            throw new \coding_exception('forumlvid must be set in $other.');
        }
    ...
    /**
     * Forumlv discussion object id mappings.
     *
     * @return array
     */
