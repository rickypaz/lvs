 ...
 */
class forumlv_post implements \renderable, \templatable {

    /**
     * The course that the forumlv post is in.
     *
     * @var object $course
     */
    ...
    /**
     * The course module for the forumlv.
     *
     * @var object $cm
     */
    protected $cm = null;
    ...
    /**
     * The forumlv that the post is in.
     *
     * @var object $forumlv
     */
    protected $forumlv = null;

    /**
     * The discussion that the forumlv post is in.
     *
    ...
    /**
     * The forumlv post being displayed.
     *
     * @var object $post
     */
    protected $post = null;
    ...
    /**
     * Whether to override forumlv display when displaying usernames.
    ...
    /**
     * Builds a renderable forumlv post
     *
     * @param object $course Course of the forumlv
     * @param object $cm Course Module of the forumlv
     * @param object $forumlv The forumlv of the post
     ...
     */
    public function __construct($course, $cm, $forumlv, $discussion, $post, $author, $recipient, $canreply) {
        $this->course = $course;
        $this->cm = $cm;
     ...
     *
     * @param \mod_forumlv_renderer $renderer The render to be used for formatting the message and attachments
     ...
     * @return stdClass Data ready for use in a mustache template
     */
    protected function export_for_template_text(\mod_forumlv_renderer $renderer) {
        return array(
            ...
            'forumlvname'                     => html_entity_decode($this->get_forumlvname()),
            ...
            'unsubscribeforumlvlink'          => $this->get_unsubscribeforumlvlink(),
            'parentpostlink'                => $this->get_parentpostlink(),

            'forumlvindexlink'                => $this->get_forumlvindexlink(),
            'forumlvviewlink'                 => $this->get_forumlvviewlink(),
     ...
     * @return stdClass Data ready for use in a mustache template
     */
    protected function export_for_template_html(\mod_forumlv_renderer $renderer) {
        return array(
            'id'                            => $this->post->id,
            'coursename'                    => $this->get_coursename(),
            'courselink'                    => $this->get_courselink(),
            'forumlvname'                     => $this->get_forumlvname(),
    ...
    /**
     * Get the link to the forumlv index for this course.
     *
     * @return string
     */
    public function get_forumlvindexlink() {
        $link = new \moodle_url(
            // Posts are viewed on the topic.
            '/mod/forumlv/index.php', array(
                'id'    => $this->course->id,
            )
        );
    ...
    /**
     * Get the link to the view page for this forumlv.
     *
     * @return string
     */
    public function get_forumlvviewlink() {
        $link = new \moodle_url(
            // Posts are viewed on the topic.
            '/mod/forumlv/view.php', array(
                'f' => $this->forumlv->id,
            )
        );
    ...
    /**
     * Get the link to unsubscribe from the forumlv.
     *
     * @return string
     */
    public function get_unsubscribeforumlvlink() {
        $link = new \moodle_url(
            '/mod/forumlv/subscribe.php', array(
                'id' => $this->forumlv->id,
            )
        );
    ...
    /**
     * ID number of the course that the forumlv is in.
     *
     * @return string
     */
    ...
    /**
     * The full name of the course that the forumlv is in.
     *
     * @return string
     */
    ...
    /**
     * The name of the course that the forumlv is in.
     *
     * @return string
     */
    ...
    /**
     * The name of the forumlv.
     *
     * @return string
     */
    public function get_forumlvname() {
        return format_string($this->forumlv->name, true);
    }
     ...
     * If the forumlv name matches the discussion name, the discussion name
     * is not typically displayed.
     *
     * @return boolean
     */
    public function get_showdiscussionname() {
        return ($this->forumlv->name !== $this->discussion->name);
    }
    ...
    public function get_postdate() {
        ...
        if (!empty($CFG->forumlv_enabletimedposts) && ($this->discussion->timestart > $postmodified)) {
    ...
    public function get_group_picture() {
        if (isset($this->userfrom->groups)) {
            $groups = $this->userfrom->groups[$this->forumlv->id];
        } else {
