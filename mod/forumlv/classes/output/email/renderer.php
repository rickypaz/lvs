...
namespace mod_forumlv\output\email;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class renderer extends \mod_forumlv_renderer {
    ...
    public function forumlv_post_template() {
        return 'forumlv_post_email_htmlemail';
    }
    ...
    public function format_message_attachments($cm, $post) {
        return forumlv_print_attachments($post, $cm, "html");
    }
}
