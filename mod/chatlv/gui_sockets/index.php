...
if (!$chatlvsid = chatlv_login_user($chatlv->id, 'sockets', $groupid, $course)) {
    print_error('cantlogin');
}

$params = "chatlv_sid=$chatlvsid";
$courseshortname = format_string($course->shortname, true, array('context' => context_course::instance($course->id)));

$chatlvname = format_string($chatlv->name, true, array('context' => $context));
$winchatlvurl = "http://$CFG->chatlv_serverhost:$CFG->chatlv_serverport?win=chatlv&amp;$params";
$winusersurl = "http://$CFG->chatlv_serverhost:$CFG->chatlv_serverport?win=users&amp;$params"
...
<html>
 <head>
  ...
  <title>
   <?php echo "$strchatlv: " . $courseshortname . ": " . $chatlvname . "$groupname" ?>
  </title>
 </head>
 <frameset cols="*,200" border="5" framespacing="no" frameborder="yes" marginwidth="2" marginheight="1">
  <frameset rows="0,*,70" border="0" framespacing="no" frameborder="no" marginwidth="2" marginheight="1">
   ...
   <frame src="<?php echo $winchatlvurl; ?>" scrolling="auto" name="msg" noresize marginwidth="2" marginheight="0">
