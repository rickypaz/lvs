...
/**
 * Defines backup_chatlv_activity_task class
 *
 * @package     mod_chatlv
 * @category    backup
...
class backup_chatlv_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the chatlv.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_chatlv_activity_structure_step('chatlv_structure', 'chatlv.xml'));
    }
    ...
    static public function encode_content_links($content) {
        ...
        $base = preg_quote($CFG->wwwroot . '/mod/chatlv', '#');

        // Link to the list of chatlvs.
        $pattern = "#(".$base."\/index.php\?id\=)([0-9]+)#";
        $content = preg_replace($pattern, '$@CHATINDEX*$2@$', $content);

        // Link to chatlv view by moduleid.
