...
/**
 * The mod_wikilv page created event.
 *
 * @package    mod_wikilv
...
/**
 * The mod_wikilv page created event class.
 *
 * @package    mod_wikilv
 * @since      Moodle 2.7
 * @copyright  2013 Rajesh Taneja <rajesh@moodle.com>
...
class page_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpagecreated', 'mod_wikilv');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the page with id '$this->objectid' for the wikilv with " .
    ...
    protected function get_legacy_logdata() {
        return(array($this->courseid, 'wikilv', 'add page',
