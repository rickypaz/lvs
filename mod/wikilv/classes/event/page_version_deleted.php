...
/**
 * The mod_wikilv page version deleted event.
 *
 * @package    mod_wikilv
...
/**
 * The mod_wikilv page version deleted event class.
 *
...
class page_version_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpageversiondeleted', 'mod_wikilv');
    }
    ...
    protected function get_legacy_logdata() {
        return(array($this->courseid, 'wikilv', 'admin', 'admin.php?pageid=' . $this->other['pageid'], $this->other['pageid'],
    ...
    public function get_url() {
        return new \moodle_url('/mod/wikilv/admin.php', array('pageid' => $this->other['pageid']));
    }
