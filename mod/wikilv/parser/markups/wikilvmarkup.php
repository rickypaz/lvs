...
abstract class wikilv_markup_parser extends generic_parser_lv { // @LVS adição do sufixo lvs
    ...
    protected function process_toc() {
        ...
        $this->returnvalues['toc'] = "<div class=\"wikilv-toc\"><p class=\"wikilv-toc-title\">" . get_string('tableofcontents', 'wikilv') . "</p>$toc</div>";
    }
    ...
    protected function format_link($text) {
        ...
        if (isset($link['new']) && $link['new']) {
            $options = array('class' => 'wikilv_newentry');
        } else {
            $options = array();
        }
