...
/**
 * Unit tests for the wikilv parser
 *
 * @package   mod_wikilv
 * @category  phpunit
...
class mod_wikilv_wikilvparser_test extends basic_testcase {

    function testCreoleMarkup() {
        $this->assertTestFiles('creole');
    }

    function testNwikilvMarkup() {
        $this->assertTestFiles('nwikilv');
    }
    ...
    private function assertTestFile($num, $markup) {
        ...
        $result = wikilv_parser_proxy::parse($input, $markup, array('pretty_print' => true));
