@mod @mod_wikilv
Feature: Users can search wikilvs
  In order to find information in wikilv
  As a user
  I need to be able to search individual and collaborative wikilvs
  ...
  @javascript
  Scenario: Searching collaborative wikilv
  ...
  @javascript
  Scenario: Searching individual wikilv
    Given I log in as "teacher1"
    And I follow "Course 1"
    And I turn editing mode on
    And I add a "Wikilv" to section "1" and I fill the form with:
  ...
  @javascript
  Scenario: Searching group wikilv
    ...
    And I turn editing mode on
    And I add a "Wikilv" to section "1" and I fill the form with:
      | Wiki name | Group wikilv name |
      | Description | Wiki description |
      | First page name | Groups index |
      | Wiki mode | Collaborative wikilv |
      | Group mode | Separate groups |
    And I follow "Group wikilv name"
