@mod @mod_wikilv
Feature: There is a choice of formats for editing a wikilv page
  In order to allow users to use their favorite wikilv format
  As a user
  I need to choose which wikilv format do I want to use
  ...
  Scenario: Creole format
    ...
    Then "div.wikilveditor-toolbar" "css_element" should exists
    # Click on bold, italic, interal link and H1
    And I click on "//div[@class='wikilveditor-toolbar']/descendant::a[1]" "xpath_element"
    And I click on "//div[@class='wikilveditor-toolbar']/descendant::a[2]" "xpath_element"
    And I click on "//div[@class='wikilveditor-toolbar']/descendant::a[4]" "xpath_element"
    And the "newcontent" field should match "**Bold text**//Italic text//[[Internal link]]" value
    And I click on "//div[@class='wikilveditor-toolbar']/descendant::a[8]" "xpath_element"
    And I press "Save"
    And I should see "Bold textItalic textInternal link"
    And I should see "Level 1 Header"
    And I should see "Table of contents"
    And I click on "Level 1 Header" "link" in the ".wikilv-toc" "css_element"
