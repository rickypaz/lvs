@mod @mod_wikilv @core_tag @javascript
Feature: Edited wikilv pages handle tags correctly
  In order to get wikilv pages properly labelled
  As a user
  ...
  Scenario: Wikilv page edition of custom tags works as expected
    ...
    And I press "Save"
    Then I should see "Example" in the ".wikilv-tags" "css_element"
    And I should see "Page" in the ".wikilv-tags" "css_element"
    And I should see "Cool" in the ".wikilv-tags" "css_element"
    And I follow "Edit"
  ...
  @javascript
  Scenario: Wikilv page edition of standard tags works as expected
    ...
    When I set the following fields to these values:
      ...
      | Tags | OT1, OT3 |
    And I press "Save"
    Then I should see "OT1" in the ".wikilv-tags" "css_element"
    And I should see "OT3" in the ".wikilv-tags" "css_element"
    And I should not see "OT2" in the ".wikilv-tags" "css_element"
    And I follow "Edit"
