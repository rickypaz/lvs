@mod @mod_wikilv
Feature: Users can comment on wikilv pages
  In order to discuss wikilv pages
  As a user
  I need to be able to comment on wikilv pages as well as editing and deleting comments
  ...
  Scenario: Student can edit and delete their own comment
    When I click on "Edit" "link" in the "wikilv-comments" "table"
    And I set the following fields to these values:
      | Comment | student 1 updated comment |
    And I press "Save"
    Then I should see "student 1 updated comment"
    And "Edit" "link" should exist in the "wikilv-comments" "table"
    And "Delete" "link" should exist in the "wikilv-comments" "table"
    And I click on "Delete" "link" in the "wikilv-comments" "table"
    And I press "Yes"
  ...
  Scenario: Student cannot edit another student's comment
    ...
    And I follow "Test wikilv name"
    And I follow "Comments"
    Then "Edit" "link" should not exist in the "wikilv-comments" "table"
    And "Delete" "link" should not exist in the "wikilv-comments" "table"
