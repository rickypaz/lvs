@mod @mod_wikilv
Feature: A history of each wikilv page is available
  In order to know how a wikilv page evolved over the time and how changed what
  As a user
  I need to check the history of a wikilv page

  @javascript
  Scenario: Wikilv page edition history changes list
