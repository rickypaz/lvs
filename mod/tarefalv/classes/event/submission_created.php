...
/**
 * The mod_tarefalv submission_created abstract event.
 *
...
/**
 * The mod_tarefalv submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_tarefalv');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'tarefalv_submission', 'restore' => 'submission');
