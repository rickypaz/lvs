...
/**
 * The mod_tarefalv grading table viewed event.
 *
...
/**
 * The mod_tarefalv grading table viewed event class.
 *
...
class grading_table_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingtableviewed', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissiongradingtable', 'tarefalv');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call grading_table_viewed::create() directly, use grading_table_viewed::create_from_tarefalv() instead.');
        }
