...
/**
 * The mod_tarefalv submission locked event.
 *
...
/**
 * The mod_tarefalv submission locked event class.
 *
 * @package    mod_tarefalv
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'tarefalv', array('id' => $user->id, 'fullname' => fullname($user)));
