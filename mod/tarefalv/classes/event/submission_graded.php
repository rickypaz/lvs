...
/**
 * The mod_tarefalv submission graded event.
 *
...
/**
 * The mod_tarefalv submission graded event class.
 *
 * @package    mod_tarefalv
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_graded extends base {
     ...
     */
    public static function create_from_grade(\tarefalv $tarefalv, \stdClass $grade) {
        $data = array(
        ...
        $event->add_record_snapshot('tarefalv_grades', $grade);
        return $event;
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_tarefalv');
    }
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'tarefalv_grades';
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('tarefalv_grades', $this->objectid);
        $this->set_legacy_logdata('grade submission', $this->tarefalv->format_grade_for_log($grade));
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'tarefalv_grades', 'restore' => 'grade');
    }
}
