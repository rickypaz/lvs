...
/**
 * The mod_tarefalv statement accepted event.
 *
...
/**
 * The mod_tarefalv statement accepted event class.
 *
 * @package    mod_tarefalv
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class statement_accepted extends base {
    ...
    public static function get_name() {
        return get_string('eventstatementaccepted', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        global $USER;
        $logmessage = get_string('submissionstatementacceptedlog', 'mod_tarefalv', fullname($USER)); // Nasty hack.
