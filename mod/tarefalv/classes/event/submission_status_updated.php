...
/**
 * The mod_tarefalv submission status updated event.
 *
...
/**
 * The mod_tarefalv submission status updated event class.
 *
...
class submission_status_updated extends base {
    ...
    public static function create_from_submission(\tarefalv $tarefalv, \stdClass $submission) {
        $data = array(
            ...
            'relateduserid' => ($tarefalv->get_instance()->teamsubmission) ? null : $submission->userid,
            'other' => array(
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusupdated', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('reverttodraftforstudent', 'tarefalv', array('id' => $user->id, 'fullname' => fullname($user)));
