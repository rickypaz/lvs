...
/**
 * The mod_tarefalv extension granted event.
 *
...
/**
 * The mod_tarefalv extension granted event class.
 *
 * @package    mod_tarefalv
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class extension_granted extends base {
     ...
     */
    public static function create_from_tarefalv(\tarefalv $tarefalv, $userid) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventextensiongranted', 'mod_tarefalv');
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call extension_granted::create() directly, use extension_granted::create_from_tarefalv() instead.');
        }
