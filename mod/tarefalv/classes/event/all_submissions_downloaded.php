...
/**
 * The mod_tarefalv all submissions downloaded event.
 *
...
/**
 * The mod_tarefalv all submissions downloaded event class.
 *
 * @package    mod_tarefalv
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class all_submissions_downloaded extends base {
    ...
    public static function get_name() {
        return get_string('eventallsubmissionsdownloaded', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('download all submissions', get_string('downloadall', 'tarefalv'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call all_submissions_downloaded::create() directly, use all_submissions_downloaded::create_from_tarefalv() instead.');
        }
