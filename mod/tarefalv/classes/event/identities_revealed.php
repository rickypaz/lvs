...
/**
 * The mod_tarefalv identities revealed event.
 *
...
/**
 * The mod_tarefalv identities revealed event class.
 *
 * @package    mod_tarefalv
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class identities_revealed extends base {
    ...
    public static function get_name() {
        return get_string('eventidentitiesrevealed', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('reveal identities', get_string('revealidentities', 'tarefalv'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call identities_revealed::create() directly, use identities_revealed::create_from_tarefalv() instead.');
        }
