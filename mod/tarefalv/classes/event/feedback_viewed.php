...
/**
 * The mod_tarefalv feedback viewed event.
 *
...
/**
 * The mod_tarefalv feedback viewed event class.
 *
...
class feedback_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventfeedbackviewed', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewfeedbackforuser', 'tarefalv', $this->relateduserid);
