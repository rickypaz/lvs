...
/**
 * The mod_tarefalv submission form viewed event.
 *
...
/**
 * The mod_tarefalv submission form viewed event class.
 *
...
class submission_confirmation_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionconfirmationformviewed', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewownsubmissionform', 'tarefalv');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_confirmation_form_viewed::create() directly, use submission_confirmation_form_viewed::create_from_tarefalv() instead.');
        }
