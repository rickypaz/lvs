...
/**
 * The mod_tarefalv grading form viewed event.
 *
...
/**
 * The mod_tarefalv grading form viewed event class.
 *
...
class grading_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingformviewed', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $msg = get_string('viewgradingformforstudent', 'tarefalv',
