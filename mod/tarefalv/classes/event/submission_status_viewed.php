...
/**
 * The mod_tarefalv submission status viewed event.
 *
...
/**
 * The mod_tarefalv submission status viewed event class.
 *
...
class submission_status_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusviewed', 'mod_tarefalv');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewownsubmissionstatus', 'tarefalv'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_status_viewed::create() directly, use submission_status_viewed::create_from_tarefalv() instead.');
        }
