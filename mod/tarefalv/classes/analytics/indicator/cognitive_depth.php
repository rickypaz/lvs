...
/**
 * Cognitive depth indicator - tarefalv.
 *
...
namespace mod_tarefalv\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_tarefalv');
    }
    ...
    protected function feedback_submitted_events() {
        return array('\mod_tarefalv\event\assessable_submitted');
    }
