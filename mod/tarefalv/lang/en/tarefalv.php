...
/**
 * Strings for component 'tarefalv', language 'en'
 *
...
$string['tarefalv:addinstance'] = 'Add a new assignment';
$string['tarefalv:exportownsubmission'] = 'Export own submission';
$string['tarefalv:editothersubmission'] = 'Edit another student\'s submission';
$string['tarefalv:grade'] = 'Grade assignment';
$string['tarefalv:grantextension'] = 'Grant extension';
$string['tarefalv:manageallocations'] = 'Manage markers allocated to submissions';
$string['tarefalv:managegrades'] = 'Review and release grades';
$string['tarefalv:manageoverrides'] = 'Manage assignment overrides';
$string['tarefalv:receivegradernotifications'] = 'Receive grader submission notifications';
$string['tarefalv:releasegrades'] = 'Release grades';
$string['tarefalv:revealidentities'] = 'Reveal student identities';
$string['tarefalv:reviewgrades'] = 'Review grades';
$string['tarefalv:viewblinddetails'] = 'View student identities when blind marking is enabled';
$string['tarefalv:viewgrades'] = 'View grades';
$string['tarefalv:submit'] = 'Submit assignment';
$string['tarefalv:view'] = 'View assignment';
$string['tarefalvfeedback'] = 'Feedback plugin';
$string['tarefalvfeedbackpluginname'] = 'Feedback plugin';
...
$string['tarefalvsubmission'] = 'Submission plugin';
$string['tarefalvsubmissionpluginname'] = 'Submission plugin';
...
$string['managetarefalvfeedbackplugins'] = 'Manage assignment feedback plugins';
$string['managetarefalvsubmissionplugins'] = 'Manage assignment submission plugins';
...
$string['messageprovider:tarefalv_notification'] = 'Assignment notifications';
...
$string['overridegroupeventname'] = '{$a->tarefalv} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->tarefalv} - Override';
$string['outlinegrade'] = 'Grade: {$a}';
$string['page-mod-tarefalv-x'] = 'Any assignment module page';
$string['page-mod-tarefalv-view'] = 'Assignment module main and submission page';
...
$string['quickgrading_help'] = 'Quick grading allows you to tarefalv grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['subplugintype_tarefalvsubmission'] = 'Submission plugin';
$string['subplugintype_tarefalvsubmission_plural'] = 'Submission plugins';
$string['subplugintype_tarefalvfeedback'] = 'Feedback plugin';
$string['subplugintype_tarefalvfeedback_plural'] = 'Feedback plugins';
