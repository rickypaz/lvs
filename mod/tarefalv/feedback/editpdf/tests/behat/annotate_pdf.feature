@mod @mod_tarefalv @tarefalvfeedback @tarefalvfeedback_editpdf @_file_upload
Feature: In an assignment, teacher can annotate PDF files during grading
  ...
  Scenario: Submit a PDF file as a student and annotate the PDF as a teacher
    ...
    And I upload "mod/tarefalv/feedback/editpdf/tests/fixtures/submission.pdf" file to "File submissions" filemanager
    And I upload "mod/tarefalv/feedback/editpdf/tests/fixtures/testgs.pdf" file to "File submissions" filemanager
