 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_tarefalvfeedback_editpdf extends behat_base {
    ...
    public function ghostscript_is_installed() {
        $testpath = tarefalvfeedback_editpdf\pdf::test_gs_path();
        if (!extension_loaded('zlib') or
            $testpath->status !== tarefalvfeedback_editpdf\pdf::GSPATH_OK) {
    ...
    public function i_draw_on_the_pdf() {
        $js = ' (function() {
    var instance = M.tarefalvfeedback_editpdf.instance;
    ...
    public function i_wait_for_all_editpdf_pages_to_load() {
        ...
        $conditions = [
            'typeof M !== "undefined"',
            'typeof M.tarefalvfeedback_editpdf !== "undefined"',
            'typeof M.tarefalvfeedback_editpdf.instance !== "undefined"',
            'M.tarefalvfeedback_editpdf.instance.documentstatus === 2',
            'M.tarefalvfeedback_editpdf.instance.pagecount === M.tarefalvfeedback_editpdf.instance.pages.length',
        ];
