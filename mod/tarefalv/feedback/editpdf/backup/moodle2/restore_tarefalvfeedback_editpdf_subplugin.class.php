 ...
 * to restore one tarefalv_feedback subplugin.
 *
 * @package   tarefalvfeedback_editpdf
 * @copyright 2013 Damyon Wiese
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_tarefalvfeedback_editpdf_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_tarefalvfeedback_editpdf_files($data) {
        $data = (object)$data;

        // In this case the id is the old gradeid which will be mapped.
        $this->add_related_files('tarefalvfeedback_editpdf',
            \tarefalvfeedback_editpdf\document_services::FINAL_PDF_FILEAREA, 'grade', null, $data->gradeid);
        $this->add_related_files('tarefalvfeedback_editpdf',
            \tarefalvfeedback_editpdf\document_services::PAGE_IMAGE_READONLY_FILEAREA, 'grade', null, $data->gradeid);
        $this->add_related_files('tarefalvfeedback_editpdf', 'stamps', 'grade', null, $data->gradeid);
    }
     ...
     * @param mixed $data
     */
    public function process_tarefalvfeedback_editpdf_annotation($data) {
        global $DB;
        ...
        $DB->insert_record('tarefalvfeedback_editpdf_annot', $data);
     ...
     * @param mixed $data
     */
    public function process_tarefalvfeedback_editpdf_comment($data) {
        global $DB;
        ...
        $DB->insert_record('tarefalvfeedback_editpdf_cmnt', $data);
