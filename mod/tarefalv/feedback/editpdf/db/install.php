 ...
 */
function xmldb_tarefalvfeedback_editpdf_install() {
    global $CFG;
    ...
    $filerecord->component = 'tarefalvfeedback_editpdf';
    ...
    foreach ($defaultstamps as $stamp) {
        ...
        $fs->create_file_from_pathname($filerecord,
            $CFG->dirroot . '/mod/tarefalv/feedback/editpdf/pix/' . $filerecord->filename);
    }
}
