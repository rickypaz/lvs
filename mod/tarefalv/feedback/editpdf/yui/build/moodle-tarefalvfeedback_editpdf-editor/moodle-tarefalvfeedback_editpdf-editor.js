YUI.add('moodle-tarefalvfeedback_editpdf-editor', function (Y, NAME) {
 ...
 */
var AJAXBASE = M.cfg.wwwroot + '/mod/tarefalv/feedback/editpdf/ajax.php',
    AJAXBASEPROGRESS = M.cfg.wwwroot + '/mod/tarefalv/feedback/editpdf/ajax_progress.php',
    CSS = {
        DIALOGUE: 'tarefalvfeedback_editpdf_widget'
    },
    SELECTOR = {
        ...
        SEARCHFILTER: '.tarefalvfeedback_editpdf_commentsearch input',
        SEARCHCOMMENTSLIST: '.tarefalvfeedback_editpdf_commentsearch ul',
        ...
        UNSAVEDCHANGESDIV: '.tarefalvfeedback_editpdf_unsavedchanges',
        UNSAVEDCHANGESINPUT: 'input[name="tarefalvfeedback_editpdf_haschanges"]',
...
var POINT = function(x, y) {
     ...
     * @method clip
     * @param M.tarefalvfeedback_editpdf.point
     * @public
     */
...
M.tarefalvfeedback_editpdf.point = POINT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.rect = RECT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var EDIT = function() {
     ...
     * @property start
     * @type M.tarefalvfeedback_editpdf.point|false
     * @public
     */
    this.start = false;
     ...
     * @property path
     * @type M.tarefalvfeedback_editpdf.point[]
     * @public
     */
    this.path = [];
};
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.edit = EDIT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 *
 * @namespace M.tarefalvfeedback_editpdf
 * @param M.tarefalvfeedback_editpdf.editor editor
 * @class drawable
 */
var DRAWABLE = function(editor) {

    /**
     * Reference to M.tarefalvfeedback_editpdf.editor.
     * @property editor
     * @type M.tarefalvfeedback_editpdf.editor
     * @public
     */
    this.editor = editor;
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.drawable = DRAWABLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATION, Y.Base, {
    ...
    /**
     * Reference to M.tarefalvfeedback_editpdf.drawable
     * @property drawable
     * @type M.tarefalvfeedback_editpdf.drawable
     * @public
     */
    drawable: false,
     ...
     * @return M.tarefalvfeedback_editpdf.drawable
     */
    draw_highlight: function() {
        ...
        if (this.editor.currentannotation === this) {
            ...
            bounds = new M.tarefalvfeedback_editpdf.rect();
            bounds.bound([new M.tarefalvfeedback_editpdf.point(this.x, this.y),
                          new M.tarefalvfeedback_editpdf.point(this.endx, this.endy)]);
            ...
            var deleteicon = Y.Node.create('<img src="' + M.util.image_url('trash', 'tarefalvfeedback_editpdf') + '"/>'),
                deletelink = Y.Node.create('<a href="#" role="button"></a>');

            deleteicon.setAttrs({
                'alt': M.util.get_string('deleteannotation', 'tarefalvfeedback_editpdf')
            });
     ...
     * @public
     * @method draw
     * @return M.tarefalvfeedback_editpdf.drawable|false
     */
    draw: function() {
     ...
     * @param M.tarefalvfeedback_editpdf.edit edit
     */
    ...
    init_from_edit: function(edit) {
        var bounds = new M.tarefalvfeedback_editpdf.rect();
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotation = ANNOTATION;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 * @extends M.tarefalvfeedback_editpdf.annotation
 */
...
Y.extend(ANNOTATIONLINE, M.tarefalvfeedback_editpdf.annotation, {
    /**
    ...
    draw: function() {
        ...
        drawable = new M.tarefalvfeedback_editpdf.drawable(this.editor);
     ...
     */
    draw_current_edit: function(edit) {
        var drawable = new M.tarefalvfeedback_editpdf.drawable(this.editor),
            shape;
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotationline = ANNOTATIONLINE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONRECTANGLE, M.tarefalvfeedback_editpdf.annotation, {
    /**
    ...
    draw_current_edit: function(edit) {
        ...
        bounds = new M.tarefalvfeedback_editpdf.rect();
        bounds.bound([new M.tarefalvfeedback_editpdf.point(edit.start.x, edit.start.y),
                      new M.tarefalvfeedback_editpdf.point(edit.end.x, edit.end.y)]);
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotationrectangle = ANNOTATIONRECTANGLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONOVAL, M.tarefalvfeedback_editpdf.annotation, {
    /**
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotationoval = ANNOTATIONOVAL;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONPEN, M.tarefalvfeedback_editpdf.annotation, {
    /**
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotationpen = ANNOTATIONPEN;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONHIGHLIGHT, M.tarefalvfeedback_editpdf.annotation, {
    /**
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotationhighlight = ANNOTATIONHIGHLIGHT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONSTAMP, M.tarefalvfeedback_editpdf.annotation, {
    /**
    ...
    draw: function() {
        ...
        position = this.editor.get_window_coordinates(new M.tarefalvfeedback_editpdf.point(this.x, this.y));
    ...
    draw_current_edit: function(edit) {
        ...
        bounds.bound([edit.start, edit.end]);
        position = this.editor.get_window_coordinates(new M.tarefalvfeedback_editpdf.point(bounds.x, bounds.y));
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.annotationstamp = ANNOTATIONSTAMP;
...
Y.extend(DROPDOWN, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.addClass('tarefalvfeedback_editpdf_dropdown');
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.dropdown = DROPDOWN;
...
Y.extend(STAMPPICKER, M.tarefalvfeedback_editpdf.dropdown, {
     ...
     */
    initializer: function(config) {
        var stamplist = Y.Node.create('<ul role="menu" class="tarefalvfeedback_editpdf_menu"/>');

        // Build a list of stamped buttons.
        Y.each(this.get('stamps'), function(stamp) {
            var button, listitem, title;

            title = M.util.get_string('stamp', 'tarefalvfeedback_editpdf');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('stamppicker', 'tarefalvfeedback_editpdf'));
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.stamppicker = STAMPPICKER;
...
Y.extend(COMMENTMENU, M.tarefalvfeedback_editpdf.dropdown, {
    ...
    initializer: function(config) {
        ...
        commentlinks = Y.Node.create('<ul role="menu" class="tarefalvfeedback_editpdf_menu"/>');

        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('addtoquicklist', 'tarefalvfeedback_editpdf') +
               '</a></li>');
        ...
        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('deletecomment', 'tarefalvfeedback_editpdf') +
               '</a></li>');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('commentcontextmenu', 'tarefalvfeedback_editpdf'));
        ...
        Y.each(comment.editor.quicklist.comments, function(quickcomment) {
            var listitem = Y.Node.create('<li class="quicklist_comment"></li>'),
                ...
                deletelinkitem = Y.Node.create('<a href="#" tabindex="-1" class="delete_quicklist_comment">' +
                                               ...
                                               'alt="' + M.util.get_string('deletecomment', 'tarefalvfeedback_editpdf') + '"/>' +
                                               '</a>');
    ...
    ATTRS: {
         ...
         *
         * @attribute comment
         * @type M.tarefalvfeedback_editpdf.comment
         * @default null
         */
        comment: {
            value: null
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.commentmenu = COMMENTMENU;
/* eslint-disable no-unused-vars */
/* global SELECTOR */
...
COMMENTSEARCH = function(config) {
    ...
    config.width = '400px';
    config.visible = false;
    config.headerContent = M.util.get_string('searchcomments', 'tarefalvfeedback_editpdf');
    config.footerContent = '';
...
Y.extend(COMMENTSEARCH, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb = this.get('boundingBox');
        bb.addClass('tarefalvfeedback_editpdf_commentsearch');

        editor = this.get('editor');
        container = Y.Node.create('<div/>');

        placeholder = M.util.get_string('filter', 'tarefalvfeedback_editpdf');
        commentfilter = Y.Node.create('<input type="text" size="20" placeholder="' + placeholder + '"/>');
        container.append(commentfilter);
        commentlist = Y.Node.create('<ul role="menu" class="tarefalvfeedback_editpdf_search"/>');
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.commentsearch = COMMENTSEARCH;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var COMMENT = function(editor, gradeid, pageno, x, y, width, colour, rawtext) {
     ...
     * @property menu
     * @type M.tarefalvfeedback_editpdf.dropdown
     * @public
     */
    this.menu = null;
        ...
        if (!this.editor.get('readonly')) {
            ...
            node.on('gesturemove', function(e) {
                if (editor.currentedit.tool === 'select') {
                    ...
                    newlocation = this.editor.get_canvas_coordinates(new M.tarefalvfeedback_editpdf.point(x, y));
            ...
            this.menu = new M.tarefalvfeedback_editpdf.commentmenu({
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.comment = COMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.quickcomment = QUICKCOMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var QUICKCOMMENTLIST = function(editor) {
     ...
     * Array of Comments
     * @property shapes
     * @type M.tarefalvfeedback_editpdf.quickcomment[]
     * @public
     */
    this.comments = [];
                ...
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            quickcomment = new M.tarefalvfeedback_editpdf.quickcomment(jsondata.id,
                                                                                     jsondata.rawtext,
                                                                                     jsondata.width,
                                                                                     jsondata.colour);
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            Y.each(jsondata, function(comment) {
                                var quickcomment = new M.tarefalvfeedback_editpdf.quickcomment(comment.id,
                                                                                             comment.rawtext,
                                                                                             comment.width,
                                                                                             comment.colour);
                                this.comments.push(quickcomment);
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.quickcommentlist = QUICKCOMMENTLIST;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EDITOR.prototype = {
     ...
     * @type M.tarefalvfeedback_editpdf.edit
     * @protected
     */
    currentedit: new M.tarefalvfeedback_editpdf.edit(),

    /**
     * Current drawable.
     *
     * @property currentdrawable
     * @type M.tarefalvfeedback_editpdf.drawable|false
     * @protected
     */
     ...
     *
     * @property drawables
     * @type array(M.tarefalvfeedback_editpdf.drawable)
     * @protected
     */
    drawables: [],
     ...
     * @type M.tarefalvfeedback_editpdf.annotation
     * @protected
     */
     ...
     * @property quicklist
     * @type M.tarefalvfeedback_editpdf.quickcommentlist
     * @protected
     */
    quicklist: null,
    ...
    initializer: function() {
        ...
        if (link) {
            ...
            require(['mod_tarefalv/grading_review_panel'], function(ReviewPanelManager) {
                var panelManager = new ReviewPanelManager();

                var panel = panelManager.getReviewPanel('tarefalvfeedback_editpdf');
                if (panel) {
                    panel = Y.one(panel);
                    panel.empty();
                ...
                if (!this.get('readonly')) {
                    this.quicklist = new M.tarefalvfeedback_editpdf.quickcommentlist(this);
                }
            }.bind(this));
    ...
    refresh_button_state: function() {
        ...
        imgurl = M.util.image_url('background_colour_' + this.currentedit.commentcolour, 'tarefalvfeedback_editpdf');
        ...
        imgurl = M.util.image_url('colour_' + this.currentedit.annotationcolour, 'tarefalvfeedback_editpdf');
        button.one('img').setAttribute('src', imgurl);

        currenttoolnode = this.get_dialogue_element(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.addClass('tarefalvfeedback_editpdf_selectedbutton');
    ...
    get_canvas_bounds: function() {
        ...
        return new M.tarefalvfeedback_editpdf.rect(offsetleft, offsettop, width, height);
    },

    /**
     * Called to translate from window coordinates to canvas coordinates.
     * @method get_canvas_coordinates
     * @param M.tarefalvfeedback_editpdf.point point in window coordinats.
     */
    get_canvas_coordinates: function(point) {
        var bounds = this.get_canvas_bounds(),
            newpoint = new M.tarefalvfeedback_editpdf.point(point.x - bounds.x, point.y - bounds.y);
    ...
    prepare_pages_for_display: function(data) {
        ...
        if (!data.pagecount) {
            ...
            error = new M.core.alert({message: M.util.get_string('cannotopenpdf', 'tarefalvfeedback_editpdf')});
            error.show();
            return;
        }
        ...
        for (i = 0; i < this.pages.length; i++) {
            for (j = 0; j < this.pages[i].comments.length; j++) {
                ...
                this.pages[i].comments[j] = new M.tarefalvfeedback_editpdf.comment(this,
                                                                                 comment.gradeid,
                                                                                 comment.pageno,
                                                                                 comment.x,
                                                                                 comment.y,
    ...
    handle_response_data: function(response) {
        ...
        try {
            ...
            if (data.error) {
                ...
                new M.core.alert({
                    message: M.util.get_string('cannotopenpdf', 'tarefalvfeedback_editpdf'),
                    visible: true
                });
            } else {
                return data;
            ...
            new M.core.alert({
                title: M.util.get_string('cannotopenpdf', 'tarefalvfeedback_editpdf'),
                visible: true
            });
        }
    ...
    setup_toolbar: function() {
        ...
        picker = new M.tarefalvfeedback_editpdf.colourpicker({
        ...
        if (stampfiles.length <= 0) {
            ...
            picker = new M.tarefalvfeedback_editpdf.stamppicker({
    ...
    handle_tool_button: function(e, tool) {
        ...
        currenttoolnode = this.get_dialogue_element(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.removeClass('tarefalvfeedback_editpdf_selectedbutton');
    ...
    get_current_drawable: function() {
        ...
        if (this.currentedit.tool === 'comment') {
            comment = new M.tarefalvfeedback_editpdf.comment(this);
    ...
    edit_move: function(e) {
        ...
        var bounds = this.get_canvas_bounds(),
            ...
            drawingregion = this.get_dialogue_element(SELECTOR.DRAWINGREGION),
            clientpoint = new M.tarefalvfeedback_editpdf.point(e.clientX + canvas.get('docScrollX'),
    ...
    create_annotation: function(type, data) {
        ...
        data.editor = this;
        if (type === "line") {
            return new M.tarefalvfeedback_editpdf.annotationline(data);
        } else if (type === "rectangle") {
            return new M.tarefalvfeedback_editpdf.annotationrectangle(data);
        } else if (type === "oval") {
            return new M.tarefalvfeedback_editpdf.annotationoval(data);
        } else if (type === "pen") {
            return new M.tarefalvfeedback_editpdf.annotationpen(data);
        } else if (type === "highlight") {
            return new M.tarefalvfeedback_editpdf.annotationhighlight(data);
        } else if (type === "stamp") {
            return new M.tarefalvfeedback_editpdf.annotationstamp(data);
        }
        return false;
    },
    ...
    open_search_comments: function(e) {
        if (!this.searchcommentswindow) {
            this.searchcommentswindow = new M.tarefalvfeedback_editpdf.commentsearch({
                editor: this
            });
        }
    ...
    setup_navigation: function() {
        ...
        if (options.size() <= 1) {
            for (i = 0; i < this.pages.length; i++) {
                ...
                option.setHTML(M.util.get_string('pagexofy', 'tarefalvfeedback_editpdf', strinfo));
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME: 'moodle-tarefalvfeedback_editpdf-editor',
    ATTRS: {
        userid: {
...
M.tarefalvfeedback_editpdf = M.tarefalvfeedback_editpdf || {};
M.tarefalvfeedback_editpdf.editor = M.tarefalvfeedback_editpdf.editor || {};
 ...
 * @param {Object} params
 */
M.tarefalvfeedback_editpdf.editor.init = M.tarefalvfeedback_editpdf.editor.init || function(params) {
    if (typeof M.tarefalvfeedback_editpdf.instance !== 'undefined') {
        M.tarefalvfeedback_editpdf.instance.destroy();
    }

    M.tarefalvfeedback_editpdf.instance = new EDITOR(params);
    return M.tarefalvfeedback_editpdf.instance;
};
