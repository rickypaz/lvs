 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_tarefalvfeedback_file_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_tarefalvfeedback_file_grade($data) {
        global $DB;
        ...
        $DB->insert_record('tarefalvfeedback_file', $data);

        $this->add_related_files('tarefalvfeedback_file', 'feedback_files', 'grade', null, $oldgradeid);
    }
