 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_tarefalvfeedback_file_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('tarefalvfeedback_file', array('grade' => backup::VAR_PARENTID));
        // The parent is the grade.
        $subpluginelement->annotate_files('tarefalvfeedback_file', 'feedback_files', 'grade');
        return $subplugin;
    }
