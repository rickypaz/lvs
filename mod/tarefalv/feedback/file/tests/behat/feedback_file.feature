@mod @mod_tarefalv @tarefalvfeedback @tarefalvfeedback_file @_file_upload
Feature: In an assignment, teacher can submit feedback files during grading
  ...
  Background:
    ...
    And I set the field "tarefalvfeedback_file_enabled" to "1"
    ...
    And I upload "mod/tarefalv/feedback/file/tests/fixtures/submission.txt" file to "File submissions" filemanager
    ...
    And I upload "mod/tarefalv/feedback/file/tests/fixtures/feedback.txt" file to "Feedback files" filemanager
