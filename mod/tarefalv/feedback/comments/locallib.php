 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_feedback_comments extends tarefalv_feedback_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'tarefalvfeedback_comments');
    }
    ...
    public function get_feedback_comments($gradeid) {
        global $DB;
        return $DB->get_record('tarefalvfeedback_comments', array('grade'=>$gradeid));
    }
    ...
    public function get_quickgrading_html($userid, $grade) {
        ...
        $pluginname = get_string('pluginname', 'tarefalvfeedback_comments');
    ...
    public function is_feedback_modified(stdClass $grade, stdClass $data) {
        ...
        if ($commenttext == $data->tarefalvfeedbackcomments_editor['text']) {
            return false;
        } else {
            return true;
        }
    ...
    public function get_editor_fields() {
        return array('comments' => get_string('pluginname', 'tarefalvfeedback_comments'));
    }
    ...
    public function set_editor_text($name, $value, $gradeid) {
        ...
        if ($name == 'comments') {
            ...
            if ($feedbackcomment) {
                ...
                return $DB->update_record('tarefalvfeedback_comments', $feedbackcomment);
            } else {
                ...
                return $DB->insert_record('tarefalvfeedback_comments', $feedbackcomment) > 0;
            }
        }
    ...
    public function save_settings(stdClass $data) {
        $this->set_config('commentinline', !empty($data->tarefalvfeedback_comments_commentinline));
        return true;
    }
    ...
    public function get_settings(MoodleQuickForm $mform) {
        ...
        if ($default === false) {
            ...
            $default = get_config('tarefalvfeedback_comments', 'inline');
        }
        $mform->addElement('selectyesno',
                           'tarefalvfeedback_comments_commentinline',
                           get_string('commentinline', 'tarefalvfeedback_comments'));
        $mform->addHelpButton('tarefalvfeedback_comments_commentinline', 'commentinline', 'tarefalvfeedback_comments');
        $mform->setDefault('tarefalvfeedback_comments_commentinline', $default);
        // Disable comment online if comment feedback plugin is disabled.
        $mform->disabledIf('tarefalvfeedback_comments_commentinline', 'tarefalvfeedback_comments_enabled', 'notchecked');
   }
    ...
    protected function convert_submission_text_to_feedback($submission, $data) {
        ...
        $data->tarefalvfeedbackcomments_editor['text'] = $text;
        $data->tarefalvfeedbackcomments_editor['format'] = $format;
    ...
    public function get_form_elements_for_user($grade, MoodleQuickForm $mform, stdClass $data, $userid) {
        ...
        if ($feedbackcomments && !empty($feedbackcomments->commenttext)) {
            $data->tarefalvfeedbackcomments_editor['text'] = $feedbackcomments->commenttext;
            $data->tarefalvfeedbackcomments_editor['format'] = $feedbackcomments->commentformat;
        } else {
        ...
        $mform->addElement('editor', 'tarefalvfeedbackcomments_editor', $this->get_name(), null, null);
    ...
    public function save(stdClass $grade, stdClass $data) {
        ...
        $feedbackcomment = $this->get_feedback_comments($grade->id);
        if ($feedbackcomment) {
            $feedbackcomment->commenttext = $data->tarefalvfeedbackcomments_editor['text'];
            $feedbackcomment->commentformat = $data->tarefalvfeedbackcomments_editor['format'];
            return $DB->update_record('tarefalvfeedback_comments', $feedbackcomment);
        } else {
            $feedbackcomment = new stdClass();
            $feedbackcomment->commenttext = $data->tarefalvfeedbackcomments_editor['text'];
    ...
    public function upgrade(context $oldcontext,
        ...
        if (!$DB->insert_record('tarefalvfeedback_comments', $feedbackcomments) > 0) {
    ...
    public function delete_instance() {
        ...
        $DB->delete_records('tarefalvfeedback_comments',
    ...
    public function get_external_parameters() {
        ...
        return array('tarefalvfeedbackcomments_editor' => $editorstructure);
    }
