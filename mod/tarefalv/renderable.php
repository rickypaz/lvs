 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_submit_for_grading_page implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_gradingmessage implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_form implements renderable {
    /** @var moodleform $form is the edit submission form */
    public $form = null;
    /** @var string $classname is the name of the class to tarefalv to the container */
    public $classname = '';
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_user_summary implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_feedback_plugin_feedback implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;

    /** @var tarefalv_submission_plugin $plugin */
    public $plugin = null;
    /** @var stdClass $grade */
    public $grade = null;
    /** @var string $view */
     ...
     *
     * @param tarefalv_feedback_plugin $plugin
     ...
     */
    public function __construct(tarefalv_feedback_plugin $plugin,
                                stdClass $grade,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_submission_plugin_submission implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;
    ...
    /**
     * Constructor
     * @param tarefalv_submission_plugin $plugin
     ...
     */
    public function __construct(tarefalv_submission_plugin $plugin,
                                stdClass $submission,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_feedback_status implements renderable {
    ...
    /** @var stdClass tarefalv_grade record */
    public $grade = null;
    /** @var int coursemoduleid */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_submission_status implements renderable {
     ...
     * @param array $usergroups - Array containing all groups the user is tarefalved to
     */
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_submission_status_compact extends tarefalv_submission_status implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_attempt_history implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_attempt_history_chooser implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        foreach ($export->submissions as $i => $submission) {
            ...
            $submission->attemptsummary = get_string('attemptheading', 'tarefalv', $attemptsummaryparams);
            $submission->statussummary = get_string('submissionstatus_' . $submission->status, 'tarefalv');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_header implements renderable {
    /** @var stdClass the tarefalv record  */
    public $tarefalv = null;
     ...
     * Constructor
     *
     * @param stdClass $tarefalv  - the tarefalv database record
     ...
     */
    public function __construct(stdClass $tarefalv,
                                $context,
                                $showintro,
                                $coursemoduleid,
                                $subpage='',
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_plugin_header implements renderable {
    /** @var tarefalv_plugin $plugin */
    public $plugin = null;

    /**
     * Header for a single plugin
     *
     * @param tarefalv_plugin $plugin
     */
    public function __construct(tarefalv_plugin $plugin) {
        $this->plugin = $plugin;
    }
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_grading_summary implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_course_index_summary implements renderable {
     ...
     */
    public function add_tarefalv_info($cmid, $cmname, $sectionname, $timedue, $submissioninfo, $gradeinfo) {
...
/**
 * An tarefalv file class that extends rendererable class and is used by the tarefalv module.
 *
 * @package   mod_tarefalv
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalv_files implements renderable {
    /** @var context $context */
    public $context;
    /** @var string $context */
    public $dir;
    ...
    public function __construct(context $context, $sid, $filearea, $component) {
        ...
        if (!empty($CFG->enableportfolios)) {
            ...
            if (count($files) >= 1 && !empty($sid) &&
                    has_capability('mod/tarefalv:exportownsubmission', $this->context)) {
    ...
    public function preprocess($dir, $filearea, $component) {
        ...
        foreach ($dir['files'] as $file) {
            ...
            if (!empty($CFG->enableportfolios)) {
                require_once($CFG->libdir . '/portfoliolib.php');
                $button = new portfolio_add_button();
                if (has_capability('mod/tarefalv:exportownsubmission', $this->context)) {
