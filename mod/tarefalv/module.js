...
M.mod_tarefalv.init_grading_table = function(Y) {
        ...
        if (batchform) {
            batchform.on('submit', function(e) {
                ...
                if (selectedusers.length == 0) {
                    alert(M.util.get_string('nousersselected', 'tarefalv'));
                    e.preventDefault();
                } else {
                    ...
                    if (action.indexOf(prefix) == 0) {
                        ...
                        confirmmessage = M.util.get_string('batchoperationconfirm' + action, 'tarefalvfeedback_' + plugin);
                    } else {
                        confirmmessage = M.util.get_string('batchoperationconfirm' + operation.get('value'), 'tarefalv');
                    }
...
M.mod_tarefalv.init_grading_options = function(Y) {
    Y.use('node', function(Y) {
...
M.mod_tarefalv.init_plugin_summary = function(Y, subtype, type, submissionid) {
