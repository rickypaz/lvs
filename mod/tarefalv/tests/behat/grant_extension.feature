...
Feature: Grant an extension to an offline student
  ...
  Scenario: Granting an extension to an offline assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | tarefalvsubmission_onlinetext_enabled | tarefalvsubmission_file_enabled | duedate    |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 0                                   | 0                             | 1388534400 |
  ...
  Scenario: Validating that extension date is after due date
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | tarefalvsubmission_onlinetext_enabled | tarefalvsubmission_file_enabled | allowsubmissionsfromdate    | duedate    |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 0                                   | 0                             | 1388534400                  | 1388620800 |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    When I navigate to "View all submissions" in current page administration
