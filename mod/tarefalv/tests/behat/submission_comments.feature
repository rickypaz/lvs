...
Feature: In an assignment, students can comment in their submissions
  ...
  Scenario: Student comments an assignment submission
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | tarefalvsubmission_onlinetext_enabled |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 1 |
  ...
  Scenario: Teacher can comment on an offline assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | tarefalvsubmission_onlinetext_enabled | assignmentsubmission_file_enabled | tarefalvfeedback_comments_enabled |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 0 | 0 | 1 |
