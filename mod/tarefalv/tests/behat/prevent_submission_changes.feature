...
Feature: Prevent or allow assignment submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | tarefalvsubmission_file_enabled | 0 |
    And I log out
  ...
  Scenario: Preventing changes and allowing them again (batch action)
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | tarefalvsubmission_onlinetext_enabled | tarefalvsubmission_file_enabled |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 1                                   | 0                             |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    And I press "Add submission"
