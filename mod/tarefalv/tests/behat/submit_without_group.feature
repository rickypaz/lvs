...
Feature: Submit assignment without group
  ...
  Scenario: Switch between group modes
    ...
    And the following "activities" exist:
      | activity | course | idnumber | name                     | intro                       | tarefalvsubmission_onlinetext_enabled | preventsubmissionnotingroup | teamsubmission |
      | tarefalv   | C1     | tarefalv1  | Allow default group      | Test assignment description | 1                                   | 0                           | 1              |
      | tarefalv   | C1     | tarefalv2  | Require group membership | Test assignment description | 1                                   | 1                           | 1              |
      | tarefalv   | C2     | tarefalv2  | Require group membership | Test assignment description | 1                                   | 1                           | 1              |
      | tarefalv   | C3     | tarefalv2  | Require group membership | Test assignment description | 1                                   | 1                           | 1              |
