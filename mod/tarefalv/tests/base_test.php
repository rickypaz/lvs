...
/**
 * Base class for unit tests for mod_tarefalv.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_tarefalv_base_testcase extends advanced_testcase {
    ...
    /**
     * Setup function - we will create a course and add an tarefalv instance to it.
     */
     ...
     * @return testable_tarefalv Testable wrapper around the tarefalv class.
     */
    protected function create_instance($params=array()) {
        ...
        return new testable_tarefalv($context, $cm, $this->course);
    }
 ...
 */
class testable_tarefalv extends tarefalv {
    ...
    public function testable_process_set_batch_marking_allocation($selectedusers, $markerid) {
        ...
        mod_tarefalv_batch_set_allocatedmarker_form::mock_submit($data);
    ...
    public function testable_process_set_batch_marking_workflow_state($selectedusers, $state) {
        ...
        mod_tarefalv_batch_set_marking_workflow_state_form::mock_submit($data);
    ...
    public function testable_view_batch_set_workflow_state($selectedusers) {
        global $PAGE;
        $PAGE->set_url('/mod/tarefalv/view.php');
    ...
    public function testable_grading_batch_operations_form($operation, $selectedusers) {
        ...
        mod_tarefalv_grading_batch_operations_form::mock_submit($data);

        // Set required variables in the form.
        $formparams = array();
        $formparams['submissiondrafts'] = 1;
        $formparams['duedate'] = 1;
        $formparams['attemptreopenmethod'] = TAREFALV_ATTEMPT_REOPEN_METHOD_MANUAL;
        ...
        $mform = new mod_tarefalv_grading_batch_operations_form(null, $formparams);
