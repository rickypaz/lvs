YUI.add('moodle-mod_tarefalv-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-tarefalv-history-link',
        OPEN: 'mod-tarefalv-history-link-open',
        CLOSED: 'mod-tarefalv-history-link-closed',
        PANEL: 'mod-tarefalv-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
