...
require_once($CFG->dirroot . '/mod/tarefalv/assignmentplugin.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class tarefalv_submission_plugin extends tarefalv_plugin {
     ...
     * @param stdClass $submission the tarefalv_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - tarefalv_submission data if any
     ...
     *
     * @param stdClass $submission - tarefalv_submission data
     * @return void
     */
