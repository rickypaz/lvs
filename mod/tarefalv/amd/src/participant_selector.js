 ...
 *
 * @module     mod_tarefalv/participants_selector
...
define(['core/ajax', 'jquery', 'core/templates'], function(ajax, $, templates) {
    ...
    return /** @alias module:mod_tarefalv/participants_selector */ {
        ...
        transport: function(selector, query, success, failure) {
            ...
            ajax.call([{
                ...
                args: {tarefalvid: assignmentid, groupid: groupid, filter: query, limit: 30, includeenrolments: false}
                ...
                $.each(results, function(index, user) {
                    ...
                    if (show) {
                        ...
                        promises.push(templates.render('mod_tarefalv/list_participant_user_summary', ctx).then(function(html) {
