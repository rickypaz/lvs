 ...
 *
 * @module     mod_tarefalv/grading_navigation_user_info
...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates'], function($, notification, ajax, templates) {
    ...
    UserInfo.prototype._refreshUserInfo = function(event, userid) {
        ...
        templates.render('mod_tarefalv/loading', {}).done(function(html, js) {
            ...
            if (userid < 0) {
                // Render the template.
                templates.render('mod_tarefalv/grading_navigation_no_users', {}).done(function(html, js) {
                    // Update the page.
                    this._region.fadeOut("fast", function() {
                        templates.replaceNodeContents(this._region, html, js);
                        this._region.fadeIn("fast");
            ...
            if (typeof this._userCache[userid] !== "undefined") {
                ...
                var requests = ajax.call([{
                    methodname: 'mod_tarefalv_get_participant',
                    args: {
                        userid: userid,
                        tarefalvid: assignmentId,
                        embeduser: true
                    }
                }]);
            ...
            promise.done(function(context) {
                ...
                templates.render('mod_tarefalv/grading_navigation_user_summary', context).done(function(html, js) {
                    // Update the page.
                    this._region.fadeOut("fast", function() {
                        templates.replaceNodeContents(this._region, html, js);
                        this._region.fadeIn("fast");
