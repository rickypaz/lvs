 ...
 *
 * @module     mod_tarefalv/grading_navigation
...
define(['jquery', 'core/notification', 'core/str', 'core/form-autocomplete',
        'core/ajax', 'mod_tarefalv/grading_form_change_checker'],
    ...
    var GradingNavigation = function(selector) {
        ...
        str.get_string('changeuser', 'mod_tarefalv').done(function(s) {
                autocomplete.enhance('[data-action=change-user]', false, 'mod_tarefalv/participant_selector', s);
            }
    ...
    GradingNavigation.prototype._loadAllUsers = function() {
        ...
        ajax.call([{
            methodname: 'mod_tarefalv_list_participants',
            args: {tarefalvid: assignmentid, groupid: groupid, filter: '', onlyids: true},
    ...
    GradingNavigation.prototype._checkClickOutsideConfigureFilters = function(event) {
        ...
        if (!configPanel.is(event.target) && configPanel.has(event.target).length === 0) {
            ...
            $(document).unbind('click.mod_tarefalv_grading_navigation');
        }
    };
    ...
    GradingNavigation.prototype._filterChanged = function(event) {
        ...
        if (filterlist.length) {
            ...
            str.get_string('nofilters', 'mod_tarefalv').done(function(s) {
    ...
    GradingNavigation.prototype._selectNoUser = function() {
        ...
        if (checker.checkFormForChanges('[data-region="grade-panel"] .gradeform')) {
            ...
            str.get_strings([
                {key: 'unsavedchanges', component: 'mod_tarefalv'},
                {key: 'unsavedchangesquestion', component: 'mod_tarefalv'},
                {key: 'saveandcontinue', component: 'mod_tarefalv'},
    ...
    GradingNavigation.prototype._toggleExpandFilters = function(event) {
        ...
        if (expanded) {
            ...
            $(document).on('click.mod_tarefalv_grading_navigation', this._checkClickOutsideConfigureFilters.bind(this));
        }
    };
    ...
    GradingNavigation.prototype._refreshCount = function() {
        ...
        if (isNaN(userid) || userid <= 0) {
            ...
            str.get_string('xofy', 'mod_tarefalv', param).done(function(s) {
