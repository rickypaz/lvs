...
/**
 * The tarefalvsubmission_comments comment created event.
 *
...
namespace tarefalvsubmission_comments\event;
defined('MOODLE_INTERNAL') || die();

/**
 * The tarefalvsubmission_comments comment created event class.
 *
 * @package    tarefalvsubmission_comments
 * @since      Moodle 2.7
 * @copyright  2013 Rajesh Taneja <rajesh@moodle.com>
