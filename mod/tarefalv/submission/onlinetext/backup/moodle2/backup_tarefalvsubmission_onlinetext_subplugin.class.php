 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_tarefalvsubmission_onlinetext_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('tarefalvsubmission_onlinetext',
                                          array('submission' => backup::VAR_PARENTID));

        $subpluginelement->annotate_files('tarefalvsubmission_onlinetext',
