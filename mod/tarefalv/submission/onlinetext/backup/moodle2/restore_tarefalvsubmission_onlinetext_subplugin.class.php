 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_tarefalvsubmission_onlinetext_subplugin extends restore_subplugin {
    ...
    /**
     * Processes one tarefalvsubmission_onlinetext element
     *
     * @param mixed $data
     */
    public function process_tarefalvsubmission_onlinetext_submission($data) {
        global $DB;
        ...
        $DB->insert_record('tarefalvsubmission_onlinetext', $data);

        $this->add_related_files('tarefalvsubmission_onlinetext', 'submissions_onlinetext', 'submission', null, $oldsubmissionid);
    }
