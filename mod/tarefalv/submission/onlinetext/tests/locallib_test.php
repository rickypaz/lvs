...
/**
 * Tests for mod/tarefalv/submission/onlinetext/locallib.php
 *
...
/**
 * Unit tests for mod/tarefalv/submission/onlinetext/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalvsubmission_onlinetext_locallib_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $params = ['course' => $this->course->id, 'tarefalvsubmission_onlinetext_enabled' => 1];
    ...
    public function test_new_submission_empty($submissiontext, $expected) {
        ...
        $result = $this->tarefalv->new_submission_empty($data);
        $this->assertTrue($result === $expected);
    }
