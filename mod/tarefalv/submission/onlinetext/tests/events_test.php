...
class tarefalvsubmission_onlinetext_events_testcase extends advanced_testcase {
    ...
    public function test_assessable_uploaded() {
        ...
        $plugin = $this->tarefalv->get_submission_plugin_by_type('onlinetext');
        ...
        $event = reset($events);
        $this->assertInstanceOf('\tarefalvsubmission_onlinetext\event\assessable_uploaded', $event);
    ...
    public function test_submission_created() {
        ...
        $this->assertCount(2, $events);
        $event = $events[1];
        $this->assertInstanceOf('\tarefalvsubmission_onlinetext\event\submission_created', $event);
        $this->assertEquals($this->context->id, $event->contextid);
    ...
    public function test_submission_updated() {
        ...
        $event = $events[3];
        $this->assertInstanceOf('\tarefalvsubmission_onlinetext\event\submission_updated', $event);
        $this->assertEquals($this->context->id, $event->contextid);
        $this->assertEquals($this->course->id, $event->courseid);
        $this->assertEquals($this->submission->id, $event->other['submissionid']);
        $this->assertEquals($this->submission->attemptnumber, $event->other['submissionattempt']);
