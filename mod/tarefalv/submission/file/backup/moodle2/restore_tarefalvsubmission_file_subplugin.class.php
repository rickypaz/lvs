 ...
 * needed to restore one tarefalv_submission subplugin.
 *
 * @package tarefalvsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_tarefalvsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_tarefalvsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('tarefalvsubmission_file', $data);

        $this->add_related_files('tarefalvsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
