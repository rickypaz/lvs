...
/**
 * Tests for mod/tarefalv/submission/file/locallib.php
 *
...
/**
 * Unit tests for mod/tarefalv/submission/file/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tarefalvsubmission_file_locallib_testcase extends advanced_testcase {
    ...
    public function test_new_submission_empty($data, $expected) {
        ...
        $result = $this->tarefalv->new_submission_empty($submission);
        $this->assertTrue($result === $expected);
    }
