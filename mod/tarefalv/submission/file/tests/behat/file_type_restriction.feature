@mod @mod_tarefalv @tarefalvsubmission_file
Feature: In an assignment, limit submittable file types
  ...
  Background:
    ...
    And the following config values are set as admin:
      | filetypes | image/png;spreadsheet | tarefalvsubmission_file |

  @javascript
  Scenario: File types validation for an assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | tarefalvsubmission_onlinetext_enabled | tarefalvsubmission_file_enabled | tarefalvsubmission_file_maxfiles | tarefalvsubmission_file_maxsizebytes |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 1388534400 | 0                                   | 1                             | 1                              | 0                                  |
  ...
  Scenario: Uploading permitted file types for an assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | tarefalvsubmission_onlinetext_enabled | tarefalvsubmission_file_enabled | tarefalvsubmission_file_maxfiles | tarefalvsubmission_file_maxsizebytes | tarefalvsubmission_file_filetypes |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 1388534400 | 0                                   | 1                             | 3                              | 0                                  | image/png,spreadsheet,.xml,.txt  |
  ...
  Scenario: No filetypes allows all
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | tarefalvsubmission_onlinetext_enabled | tarefalvsubmission_file_enabled | tarefalvsubmission_file_maxfiles | tarefalvsubmission_file_maxsizebytes | tarefalvsubmission_file_filetypes |
      | tarefalv   | C1     | tarefalv1  | Test assignment name | Test assignment description | 1388534400 | 0                                   | 1                             | 2                              | 0                                  |                                 |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test assignment name"
    When I press "Add submission"
