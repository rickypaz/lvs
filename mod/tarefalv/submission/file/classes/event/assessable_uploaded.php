...
/**
 * The tarefalvsubmission_file assessable uploaded event.
 *
...
/**
 * The tarefalvsubmission_file assessable uploaded event class.
 *
 * @package    tarefalvsubmission_file
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'tarefalvsubmission_file');
    }
